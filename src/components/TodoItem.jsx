    ...
    <li>
      <label className="flex items-center w-full"> 
        ...
        />
          ...
          {todoContent}
          <button className="flex-none p-1.5 bg-pink-600 rounded-md hover:rounded-lg hover:bg-pink-700 transition-all duration-300 text-white" onClick={() => deleteTodo(id)}> 
